...
| [date\_added] | datetime | Datetime when task was generated by FillQueueAll |
| [date\_started] | datetime | Datetime when task was taken by worker |
| [date\_completed] | datetime | Datetime when task was completed by worker |
